...
namespace integrals
{
    ...
    using surface_data = std::vector<element>;
    ...
    // refer to 2103.10917
    void polarization_midrapidity(double pT, double phi, pdg_particle particle, surface_data &freeze_out_sup, std::ofstream &fileout);
